...
public:
	...
	virtual std::vector<bool> planePoints(const Eigen::Hyperplane<double, 3> &thisPlane, size_t &thisSize);
	...
	virtual void removePoints(const std::vector<bool>& planePoints, int plane);
